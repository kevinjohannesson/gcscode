...
- [ ] **Multi-model evaluation iteration** — small decision-spec triggered when the 5th spec/ADR PR with multi-model red-team has merged (OR earlier if the two-extreme tripwire fires). Decides KEEP-BOTH / KEEP-OPUS-ONLY / KEEP-SONNET-ONLY / EXTEND-TO-10 per the methodology in [`specs/2026-05-16-multi-model-red-team-v1.md`](specs/2026-05-16-multi-model-red-team-v1.md). If KEEP-BOTH lands, ADR-0009 ("Reviewer-role registry secondary-model field") gets written at the same time.
